...
#define FOREACH_BUILTIN_TYPE(PBT) \
    ...
    PBT(type_data,    'd',    "data",       1) \
    PBT(type_func,    '(',    "func",       2) \
    PBT(type_generic, 'g',    "generic",    3) \
    PBT(type_int,     'i',    "int",        4) \
    PBT(type_int16,   's',    "int16",      5) \
    PBT(type_int32,   'i',    "int32",      6) \
    PBT(type_int8,    't',    "int8",       7) \
    PBT(type_int64,   'l',    "int64",      8) \
    PBT(type_list,    '[',    "list",       9) \
    PBT(type_str,     's',    "str",        10) \
