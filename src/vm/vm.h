...
#define NEART_INSTR_FORECH(FOR_EACH) \
    FOR_EACH(0x0, N_END,    0b00000, instr_ret,                 "return this function") \
    ...
    FOR_EACH(0x7, NR_L32,   0b10110, instr_reg_load_int32, "load an int32") \
    FOR_EACH(0x8, N_ENTER,  0b00100, instr_enter,               "the beginning of a method") \
  //FOR_EACH(0x9, N_TCALL,  0b00100, instr_tail_call,           "call a function again and override the stack frame") \
